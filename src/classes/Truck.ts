...
class Truck extends Vehicle implements AbleToTow {
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    // TODO: Get the make an model of the vehicle if it exist
    ...
    if (vehicleWeight <= this.towingCapacity) {
      ...
      console.log(`Cannot tow ${vehicleMake} ${vehicleModel} because it is too heavy to be towed`);
    }
  } 

    // TODO: Override the printDetails method from the Vehicle class
    override printDetails(): void {
    // TODO: The method should call the printDetails method of the parent class Vehicle
    super.printDetails();
